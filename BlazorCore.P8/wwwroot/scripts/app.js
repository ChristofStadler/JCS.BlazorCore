var App = {
    ...
    RenderUI: function () {
        ...
        setInterval(function () {
            DotNet.invokeMethodAsync(App.Assembly, 'Render').then(r => console.log(r));
        }, 1000);
    },
    InputListener: function () {
        ...
        document.onkeypress = function (e) {
            ...
            DotNet.invokeMethodAsync(App.Assembly, 'KeyPressed', charStr, uid, session).then(r => console.log(r));
            return;
        };
